...
const adminNavigation = [
  ...
  { name: "Estadísticas", href: "/stats", icon: BarChart3, roles: ["admin", "manager", "VENDEDOR","GERENTE_VENTAS"] },
  { name: "Sincronizar", href: "/sync", icon: RefreshCw, roles: ["admin", "manager", "VENDEDOR","GERENTE_VENTAS"] },
  { name: "Configuración", href: "/settings", icon: Settings, roles: ["admin", "manager", "VENDEDOR","GERENTE_VENTAS"] },
]
